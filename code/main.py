...
cap = cv2.VideoCapture(0) # Solo tengo una camara
...
while cap.isOpened():
    ...
    results = model( #Aqui pasamos lo que quiero analizar nada mas
        frame, 
        #conf=0.4,
        classes=[2] #  sI QUIERO CAMBIAR A SOLO DETECTAR UNA CLASE, VA aqui 
        )
    ...
    boxes_obj = results[0].boxes #Es lo que nos permite definir el rectangulo rojo
